...
export const router = {
  ...
  companiesAPI: lazy(() =>
    import("@/features/companies/api").then((m) => ({
  ...
  invoicesAPI: lazy(() =>
    import("@/features/invoices/api").then((m) => ({
      default: m.invoicesAPI,
    })),
  ),
  formsAPI: lazy(() =>
  ...
  dealCommentsAPI: lazy(() =>
    import("@/features/deal-comments/api").then((m) => ({
