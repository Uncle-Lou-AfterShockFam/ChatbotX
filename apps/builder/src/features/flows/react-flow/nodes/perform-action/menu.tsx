...
export const performActionMenus = (t: TranslationFn): MenuItem[] => [
  ...
  {
    label: t("flows.actions.dealActions"),
    icon: HandshakeIcon,
    stepType: null,
    children: [
      {
        label: t("flows.actions.createDeal"),
        icon: HandshakeIcon,
        stepType: stepTypes.enum.createDeal,
      },
      {
        label: t("flows.actions.moveDealStage"),
        icon: KanbanIcon,
        stepType: stepTypes.enum.moveDealStage,
      },
      {
        label: t("flows.actions.setDealStatus"),
        icon: TrophyIcon,
        stepType: stepTypes.enum.setDealStatus,
      },
      {
        label: t("flows.actions.createTask"),
        icon: ListChecksIcon,
        stepType: stepTypes.enum.createTask,
      },
      {
        label: t("flows.actions.completeTask"),
        icon: CheckCheckIcon,
