...
ALTER TABLE "DealTaskTemplateDependency" ADD CONSTRAINT "DealTaskTemplateDependency_cXT90obvcKI2_fkey" FOREIGN KEY ("dependsOnTemplateId") REFERENCES "DealTaskTemplate"("id") ON DELETE CASCADE ON UPDATE CASCADE;